...
public class CariFilmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_film);
    ...
    private void getData() {
        ...
        String keyword = intent.getStringExtra("query");
        String endpoint = "https://us-east-1.aws.data.mongodb-api.com/app/projekmovie-szhmv/endpoint/cariFilm";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (success) {
                                ...
                                int totalData = listFilm.size();
                                String totalDataText;
                                if (totalData == 0) {
                                    totalDataText = "0 Film";
                                } else {
                                    totalDataText = totalData + " Film";
                                }
